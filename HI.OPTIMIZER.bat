...
color 0f
chcp 65001 >nul 2>&1
echo  HI+OPTIMIZER V6 Beta
echo  BY SOFT DAISY® 2026
timeout /t 2 >nul
cls
color 0b
chcp 65001 >nul 2>&1
...
echo.                         ╔═════════════════════════════════════════════════════════════════════╗ 
echo.                         ║                                                                     ║ 
echo.                         ║     [1] LATENCY TWEAKS            [2] SYSTEM TWEAKS/PERF            ║
echo.                         ║     [3] WIFI FIX                  [0] BACK                          ║
echo.                         ║                                                                     ║
echo.                         ╚═════════════════════════════════════════════════════════════════════╝
...
echo %Blue%
if "%option%"=="1" (
    echo [%DATE% %TIME%] Priority Separation Options: User Chose "Option 1" - FPS Preset. >>      
    ...
    echo [%DATE% %TIME%] Priority Separation Options: User Chose "Option 2" - Latency Preset. >>      
    ...
    echo [%DATE% %TIME%] Priority Separation Options: User Chose "Option 3" - Balanced Preset. >>      
    ...
    echo [%DATE% %TIME%] Priority Separation Options: User Chose "Option 4" - Custom Value. >>   
    goto :Custom_Priority_Separation
) else if "%option%"=="5" (
    echo [%DATE% %TIME%] Priority Separation Options: User Chose "Option 5" - Learn More. >>
pause
goto extras    
:: ====================== 
:: CPU MENU 
